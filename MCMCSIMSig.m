function [kpost, Dpost, psipost, weights, successk, successD] = MCMCSIMSig(x, z, t, kmin, kmax, k, SIGMAk, Dmin, Dmax, D, SIGMAD, N, nu, tau, thinfact)

%The inputs of the function are:
%
% x           = depth, in cm
% z           = tracer site fraction, at distances corresponding to x
% t           = time associated with the SIMS dataset
...
% SUCCESSD    = The fraction of accepted D*
    ...
    for i = 2:N
        ...
        [proposedy] = SIMS(x, kpost(i), proposedD, t);
